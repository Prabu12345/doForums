        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header header-theme">
                    {$MANAGING_LICENSES}
                    <button type="button" data-toggle="modal" data-target="#modal-addLicense" class="btn btn-theme btn-sm float-right">{$ADD_LICENSE}</button>
                </div>
                <div class="card-body">
                    {if isset($SUCCESS)}
        ...
        <div class="modal-content">
            ...
            <form action="" method="post" id="addLicense">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-theme" id="submitAddLicense" disabled>{$SUBMIT}</button>
                </div>
            </form>
        </div>
    </div>
